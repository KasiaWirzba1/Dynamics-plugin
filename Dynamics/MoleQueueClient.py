...
class MoleQueueClient:
    ...
    def _send_request(self, method, params):
        ...
        try:
            ...
            if response_raw:
                ...
                print("MoleQueueClient: empty response from MoleQueue")
                return None
        except Exception as e:
    ...
    def _receive_response(self):
        ...
        try:
            ...
            print("MoleQueueClient: timeout waiting for response")
            return None
    ...
    def submit_job(self, queue, program, input_files, project_name):
        ...
        Args:
            ...
            input_files (list): List where first element is script path, second is project name.
        ...
        params = {
            ...
            "localWorkingDirectory": os.path.expanduser("~/.dynamics/{}".format(project_name)),
            "arguments": input_files[1] if len(input_files) > 1 else "",
        }
